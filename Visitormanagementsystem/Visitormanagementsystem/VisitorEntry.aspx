<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VisitorEntry.aspx.cs" Inherits="Visitormanagementsystem.VisitorEntry" %>
...
<head runat="server">
    ...
    <script>
        ...
        let video, canvas, preview, btnCapture, btnRetake, btnShow;
...
<body>
    <form id="form1" runat="server">
        <div class="sidebar">
            <h2>VMS</h2><a href="Dashborad.aspx">🏠 Dashboard</a>
        ...
        <div class="main">
            <div class="card">
                ...
                <div class="form-grid">
                  ...
                  <div class="form-group full">
                      <video id="video" width="260" height="200" autoplay muted playsinline style="border-radius:10px; border:1px solid #ccc;"></video>
                      <canvas id="canvas" width="260" height="200" style="display:none;"></canvas>
                      <img id="preview" width="260" height="200" style="display:none; border-radius:10px; border:1px solid #ccc;" />
                      <br /><br />
                      <button type="button" id="btnCapture">📸 Capture</button>
                      <button type="button" id="btnRetake" style="display:none;">🔄 Retake</button>
                      <button type="button" id="btnShow" style="display:none;">👁 Show Photo</button>
